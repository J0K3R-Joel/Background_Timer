...
# ------------- TIMER --------------
timer_button_mode = ctk.CTkButton(mode_site, text='Timer')
stop_watch_button_mode = ctk.CTkButton(mode_site, text='Stop Watch')
alarm_button_mode = ctk.CTkButton(mode_site, text='Alarm')
